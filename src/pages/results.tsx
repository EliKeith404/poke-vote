...
const Results = () => {
	// States
	const [selectedCategory, setSelectedCategory] = useState<Category>(Category.roundest);
	...
	return (
		<>
			<Head>
				...
				/>
				<meta name="image" property="og:image" content="/preview-images/resultsPreview.jpg" />
				{/* Twitter Card */}
				...
				/>
				<meta name="twitter:image:alt" content="PokeVote's top 10 results page" />
			</Head>
	...
	return (
		<Paper className="grid grid-cols-4 mx-auto px-3 md:px-10" withBorder>
			...
			<div className="flex flex-col items-center m-auto">
				...
				<span className="capitalize text-sm md:text-lg">{ALL_POKEMON[pokemon.id - 1]}</span>
			</div>
			<p className="text-sm md:text-lg px-5 m-auto">{pokemon.votePercent.toFixed(2)}%</p>
		</Paper>
	);
};
