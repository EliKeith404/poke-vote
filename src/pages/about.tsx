    ...
    <Container>
      ...
      <Accordion variant="contained" radius="md" defaultValue="whatIsThis">
        <Accordion.Item value="whatIsThis">
          ...
          <Accordion.Panel>
            A voting app designed to gather data on how the community would rank
            Pokemon given subjective categories.
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item value="roundest">
          ...
          <Accordion.Panel>
            ...
            into this app, all 905 (currently) of them. New vote categories are
            being added all the time, so check back for new votes!
          </Accordion.Panel>
        </Accordion.Item>
